...
export const cv = [
    ...
    "Summary",
    "------------------------------",
    "Full-stack software engineer in the 'Tech for Good' space, with over a decade of experience",
    "in the software industry.",
    "Dedicated, hard-working, and passionate about software, with a penchant for readable,",
    ...
    "Duties:-",
    "  - Currently building an internal AI platform using GPT 3.5 in React, FastAPI to assist", 
    "  	 with tendering for contracts and internal policy queries",
    "  - Contracted to the NHS as a Tech Lead to build a greenfield ",
    "    Vaccinations FHIR API proof of concept",
    "  - Contracted to the NHS as a Data Engineer to work on vaccinations data pipelines using",
    "    DataBricks data lake and Apache Spark for ETL processes",
    "",
    "Role: Security Software Engineer",
    "Where: ANS Group Limited", 
    "When: November 2021 to August 2022",
    "Duties:-",
    "  - Developing secure and scalable micro-services to manage and parse data between",
    "    other internal services using Python and FastAPI",
    "  - Maintenance and administration the Elastic Stack (Elasticsearch, Logstash, Kibana)",
    "    for log aggregation and analysis",
    "  - Refactoring the existing codebase to make it more performant, maintainable and scalable",
    ...
    "Duties:-",
    "  - Specialist in developing FourJs desktop and server applications in an agile environment",
    ...
    "    AWS services",
    "  - Interrogation, configuration and management of relational databases using SQL",
    "  - Database and application migrations from legacy systems to newer, more modern", 
    "    technologies",
    ...
    "Duties:-",
    "  - Code changes to desktop and server applications in an agile environment at a junior", 
    "    level",
